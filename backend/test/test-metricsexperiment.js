...
import Variants from '../lib/metrics/variants'
...
const Services = {
  startup: {
    getStartupInfo: sinon.stub().returns({ process: new Date() })
  }
}
const storage = {}
...
const Experiment = proxyquire('../lib/metrics/experiment', {
...
describe('Experiment', function () {
  ...
  describe('ping', function () {
    it('submits to telemetry', function () {
      ...
      assert.ok(TelemetryController.submitExternalPing.calledWith('testpilottest'))
    })
